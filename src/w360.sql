...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2025 at 07:09 PM
...
VALUES (1, 11, 'accepted', '', '2025-04-10 11:01:40');
-- --------------------------------------------------------
--
...
VALUES (2, 5, 0.50, '2025-04-01', '2025-04-30', 1),
...
VALUES (
    ...
    '2025-04-09 07:18:23',
    'rejected',
    'Giveaway items for environmental awareness campaign.',
    '2025-03-03 04:15:00',
    'jiii'
  );
-- --------------------------------------------------------
...
VALUES (1, 1, 'sd', 'January', '2025-04-22'),
...
VALUES (
    4,
    'Oxo-Degradable Garbage Bag',
    'oxo_bag.jpg',
    'Eco-conscious garbage bags made with oxo-degradable material that breaks down over time.',
    0
  ),
  (
    5,
    'Bio-Degradable Garbage Bag',
    'bio_bag.jpg',
    'Compostable garbage bags made from natural materials, safe for the environment.',
    0
  ),
  (
    6,
    'Hydrogen Garbage Bag',
    'hydrogen_bag.jpg',
    'Innovative hydrogen-based garbage bags designed for enhanced odor control and decomposition.',
    1
  ),
...
INSERT INTO `user` (`user_id`, `email`, `password`, `role_id`)
VALUES (1, 'admin@gmail.com', '123456', 1),
  (2, 'upeka@gmail.com', '1234', 5),
  (3, 'lakindu@gmail.com', '5555555', 5),
  (4, 'nimasha@gmail.com', '444444', 4),
  (5, 'sajani@gmail.com', '112233', 3),
  (8, 'kumarage@gmail.com', '2001', 2),
  (
    9,
    'ravi@gmail.com',
    '$2y$10$V5c4L0fOCtCxfZN25t5XOeNpEafxxMACuPrfbQ0RruxgyeDrTq94e',
    3
  ),
  (
    10,
    'nethmii@gmail.com',
    '$2y$10$saS26lvj45ssLCEb72iyjOc9xNAZlM3bCph/j9e2HzoSCNG3NV/y6',
    4
  ),
  (
    11,
    'chamudi@gmail.com',
    '$2y$10$7ylG8WlGqYZTBAGUHCj1lemceytfJSJdtoAN4lAmJ5oGuXMoZBy4e',
    3
  );
--
...
--
ALTER TABLE `polytheneamount`
MODIFY `polythene_id` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 7;
--
