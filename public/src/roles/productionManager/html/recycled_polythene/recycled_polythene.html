...
<head>
  ...
  <link rel="stylesheet" href="../../styles/recycled_polythene/recycled_polythene.css">
    ...
    <div class="sidebar-container">
      ...
      <div>
        <ul>
          ...
          <li>
            <a href="#" class="sidebar-active"><img src="../../../../assets/recycle.svg" /><span
                class="sidebar-titles">Recycled Polythene</span></a>
          </li>
          <li>
            <a href="../../html/polythene_collection/schedule.html"><img
                src="../../../../assets/collection.svg" alt="site Performance" /><span class="sidebar-titles">Polythene
                Collection</span></a>
          </li>
          <li>
            <a href="../supply_requests/supply_request.html"><img
                src="../../../../assets/supply.svg" alt="supply" /><span class="sidebar-titles">Supply Requests</span></a>
          </li>
          <li>
