function openCompletedReturnPopup(returnData) {
    ...
    document.getElementById('decision_reason').value = returnData.decision_reason;
    document.getElementById('message_to_customer').value = returnData.message_to_customer;

    document.getElementById('completedReturnPopup').style.display = 'flex';

    // Add event listener to close the popup
  document.getElementById('closePopupBtn').addEventListener('click', () => {
    document.getElementById('completedReturnPopup').style.display = 'none';
  });
}
