...
-- --------------------------------------------------------
--
-- Table structure for table `bagSize`
--
CREATE TABLE bag_size(
  bag_id int NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE product_has_bag_sizes (
  ...
  bag_id INT,
  price DECIMAL(10, 2),
  PRIMARY KEY (Product_id, bag_id),
  FOREIGN KEY (Product_id) REFERENCES product(Product_id) ON DELETE CASCADE,
  FOREIGN KEY (bag_id) REFERENCES bag_size(bag_id) ON DELETE CASCADE
);
--
...
VALUES (1, 'lakindu@gmail.com', '111111', 1),
  (3, 'nethmi@gmail.com', '333333', 3),
  (4, 'nimasha@gmail.com', '444444', 4);
--
-- Indexes for dumped tables
--
Table structure for table `ads_and_banners` CREATE TABLE ads_and_banners(
...
--
ALTER TABLE `polytheneamount`
MODIFY `amount_id` int(50) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 10;
--
