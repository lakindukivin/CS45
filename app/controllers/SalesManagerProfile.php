...
class SalesManagerProfile
{
    ...
    {
        // Check if user is logged in and is a Sales Marketing Manager
        ...
        $this->model = new SalesManagerProfileModel();
    }
    public function index()
    {
        ...
        $this->view('salesManager/myprofile', $data);
    }
