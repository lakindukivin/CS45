...
class ProductionManagerProfileModel
{
    use Model;
    ...
    public function getProfileData($userId)
    {
        $query = "SELECT s.*, u.email, r.role as role_name 
                  ...
                  WHERE s.user_id = :user_id AND u.role_id = 3";
    ...
    public function changePassword($userId, $currentPassword, $newPassword)
    {
        ...
        $query = "SELECT password FROM user WHERE user_id = :user_id AND role_id = 3";
