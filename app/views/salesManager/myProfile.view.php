...
<head>
    ...
    <link rel="stylesheet" href="<?= ROOT ?>/assets/css/salesManager/myprofile.css" />
    <title>Profile | <?= $profile->role_name ?? 'Sales Manager' ?></title>
</head>
    ...
    <body>
        <nav id="sidebar">
            ...
            <div class="sidebar-container">
                <div class="prof-picture">
                    ...
                    <?php endif; ?>
                    <span class="user-title"><?= $profile->role_name ?? 'Sales Manager' ?></span>
                </div>
                ...
                <div>
                    <ul>
                        <li>
                            <a href="<?= ROOT ?>/salesManagerHome" class="sidebar-active">
        ...
        <div class="content">
            <header class="header">
                ...
                <nav class="nav">
                    <ul>
                        <li><a href="<?= ROOT ?>/SalesManagerProfile" class="active">Profile</a></li>
                ...
                <div class="profile-card">
                    <div class="profile-header">
                        ...
                        <div class="profile-title">
                            ...
                            <p><?= $profile->role_name ?? 'Sales Manager' ?></p>
                        </div>
                    </div>
                    ...
                    <div class="tab-content" id="personal-tab">
                        <div class="profile-details">
                            <form action="<?= ROOT ?>/SalesManagerProfile/update" method="POST"
                    ...
                    <div class="tab-content" id="password-tab" style="display: none;">
                        <div class="profile-details">
                            <form action="<?= ROOT ?>/SalesManagerProfile/changePassword" method="POST">
                                <div class="form-group">
