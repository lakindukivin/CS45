...
<head>
    ...
    <title>Oxo-biodegradable Bag</title>
    <link rel="stylesheet" href="<?= ROOT ?>/assets/css/regularBagForm.css" />
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap"
        rel="stylesheet" />
    <script src="<?= ROOT ?>/assets/js/oxoBagForm.js" defer></script>
</head>
    ...
    <main>
        <div class="product-image">
            <img
                ...
                alt="Oxo-biodegradable bag" />
        </div>
        <div class="product-details">
            <h2>Oxo-biodegradable Bag Packs</h2>
            <h3>LKR 200 - LKR 5000</h3>
            <p>Description</p>
            <div class="dropdown">
