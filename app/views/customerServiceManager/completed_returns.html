...
<head>
    ...
    <link rel="stylesheet" href="../../styles/returns/completed_returns.css">
...
<body>
      ...
      <div class="sidebar-container">
        ...
        <div>
          <ul>
            ...
            <li>
              <a href="../returns/returns.html" class="sidebar-active"
            ...
            <li>
              <a href="../manage_reviews/manage_reviews.html"
  ...
  <script src="../../javaScript/returns/completed_returns.js"></script>  
</body>
</html>